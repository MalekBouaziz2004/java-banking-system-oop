...
public interface Bank {
    ...
    /**
     * Löscht ein Konto mitsamt allen gespeicherten Transaktionen.
     *
     * @param account Kontoname
     * @throws AccountDoesNotExistException wenn das Konto nicht existiert
     * @throws IOException wenn JSON-Datei nicht gelöscht werden kann
     */
    void deleteAccount(String account) throws AccountDoesNotExistException, IOException;

    /**
     * Liefert alphabetisch sortierte Liste aller Kontonamen.
     *
     * @return Liste der Account-Namen
     */
